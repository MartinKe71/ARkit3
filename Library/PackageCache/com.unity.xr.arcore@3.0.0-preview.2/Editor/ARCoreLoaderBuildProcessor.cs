...
namespace UnityEngine.XR.ARCore
{
    ...
    /// </summary>
    public class ARCoreLoaderBuildProcessor : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        void CleanOldSettings()
        {
            ...
            var oldSettings = from s in preloadedAssets
                where s != null && s.GetType() == typeof(ARCoreLoaderSettings)
                select s;
